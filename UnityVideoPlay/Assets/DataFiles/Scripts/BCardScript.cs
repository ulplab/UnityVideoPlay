...
public class BCardScript : MonoBehaviour, IVirtualButtonEventHandler {
	...
	void Update () {
        ...
        GetComponentInChildren<TextMesh>().text= info.Mensaje.Clone().ToString();//
...
public class TCPTestClient
{
            ...
            while (true)
            {
                ...
                using (NetworkStream stream = socketConnection.GetStream())
                {
                    ...
                    while (!re.EndOfStream) {
                        ...
                        string serverMessage = JsonConvert.DeserializeObject<Info>(data).Mensaje;
    ...
    public void SendMessage(string msg)
    {
        ...
        try
        {
            ...
            wr.AutoFlush = true;
            wr.WriteLine(JsonConvert.SerializeObject(new Info() { Mensaje = msg}));
            //if (stream.CanWrite)
            //{
